...
to setup
  ...
  create-trucks
  set time-factor 16 ; 16 hours in a day
...
to create-distribution-center
  create-distribution-centers 4 [
    ...
    set distribution-center-gas 1000000000 ; Set an initial amount of gas
  ]
end
...
to create-service-station
  create-stations 578 [
    ...
    set gas-consumption-rate 2630 ; Fixed gas consumption rate at the service station
    set service-station-gas 305000 ; Set an initial amount of gas
    set service-station-gas-threshold 10000 ; Minimum gas level for the service station
  ]
end
